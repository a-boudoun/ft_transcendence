...
const User = ({user, isMe} : {user : userDto, isMe: boolean}) => {
  ...
  <div className='relative overflow-hidden sm:rounded-3xl sm:shadow-2xl'>
    <Image className='w-full h-full'  src={user.baner} alt='baner' width={1000} height={1000} />
    { isMe && <label className="absolute right-0 bottom-[110px] sm:bottom-[134px] bg-blue text-sm text-black rounded-2xl px-8 py-2 cursor-pointer ">change baner image
