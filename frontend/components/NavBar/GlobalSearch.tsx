...
const SearchBarDropDown = ({search} : {search : string}) => {
  ...
  return (
      <div 
      className='absolute top-11 w-52 sm:w-72 max-h-56  p-4 flex flex-col gap-1 overflow-y-scroll rounded-2xl bg-black bg-opacity-50 ackdrop-blur-lg drop-shadow-lg'>
      {
