			...
			<div className="flex flex-col items-center gap-8 pt-8 sm:gap-16 sm:pt-32">
				...
				<div className="flex justify-center gap-8 items-center flex-col sm:flex-row w-full">
						...
						<div
							...
							<Image width={400} height={400} alt="football" src="/game/football-map-select.webp" className="h-full w-full"/>
						...
						<div 
							...
							<Image width={400} height={400} alt="space" src="/game/space-map-select.webp" className="h-full w-full"/>
						...
						<div 
							...
							<Image width={400} height={400} alt="default" src="/game/default-map-select.webp" className="h-full w-full"/>
